...
module.exports = function(app) {
  ...
  app.patch('/api/users', users.changePassword);
  ...
  app.post('/api/users/:id/attachments', authorize.asAdministrator(), users.addAttachment);
  ...
  app.get('/api/patients/search', authorize.asAdministrator(), patients.search);
